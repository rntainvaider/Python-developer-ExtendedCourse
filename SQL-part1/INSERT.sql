...
INSERT INTO tracks (name, year, album_id)
VALUES ('Моя игра', 2000, 1),
        ('Любовь без памяти', 2001, 2),
        ('Осень', 2000, 3),
        ('Ты так мне необходим', 2002, 2),
        ('Моя Вселенная', 2003, 3),
        ('Солнца не видно', 2005, 1);
